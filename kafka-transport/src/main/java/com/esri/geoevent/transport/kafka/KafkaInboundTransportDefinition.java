...
public class KafkaInboundTransportDefinition extends TransportDefinitionBase {
  ...
  public KafkaInboundTransportDefinition()
  {
    ...
    try
    {
      ...
      propertyDefinitions.put("groupId", new PropertyDefinition("groupId", PropertyType.String, "", "${com.esri.geoevent.transport.kafka-transport.GROUP_ID_LBL}", "${com.esri.geoevent.transport.kafka-transport.GROUP_ID_DESC}", true, false));
    }
